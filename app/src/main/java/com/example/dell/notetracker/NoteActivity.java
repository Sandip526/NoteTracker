...
public class NoteActivity extends AppCompatActivity {
    ...
    private void saveNote(){
        ...
        if (Utilities.saveNote(this, note)){
            ...
            Toast.makeText(this, "Can't save the note,please make sure you have enough space on your device"
    ...
    private void deleteNote(){
        if (mLoadedNote == null) {
            ...
            AlertDialog.Builder dialog = new AlertDialog.Builder(this)
                    ...
                    .setMessage("You are about to delete" + mEtTitle.getText()
                    .toString()+",are you sure ?").setPositiveButton("yes", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Utilities.deleteNote(getApplicationContext(),mLoadedNote.getDateTime()+Utilities.FILE_EXTENSION);
                            Toast.makeText(getApplicationContext(),mEtTitle.getText().toString()+"is delete",
                                    Toast.LENGTH_SHORT).show();
                            finish();
